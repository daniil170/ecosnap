      ...
      : "text-slate-900"
            ...
            <div className="flex items-center gap-2 justify-center md:justify-start text-emerald-600 font-bold text-sm mt-1">
              ...
              <span className="flex items-center gap-1 text-slate-400">
                <MapPin size={14} /> {userData.city || "Не указан"},{" "}
                {userData.country || "Земля"}
              </span>
            </div>
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                >
                  {showAllAch ? (
                    ...
                    <>
                      <ChevronDown size={16} /> Показать все (
                ...
                {visibleAchievements.map((ach) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-6 rounded-[2rem] border-2 transition-all flex flex-col items-center gap-4 ${isLocked ? "bg-slate-50 border-transparent opacity-30 grayscale" : "bg-white border-emerald-100 shadow-md hover:scale-105"}`}
                    >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-slate-400 font-medium">
                          Вы внесли вклад в экологию. +25 XP
                        </p>
                      </div>
                    </div>
                    <ChevronRight
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="relative z-10 text-center md:text-left">
                ...
                <h3 className="text-xl font-bold mb-2 uppercase italic tracking-tighter">
                  В бой за чистоту!
                </h3>
                <p className="text-slate-400 text-xs font-medium leading-relaxed">
                  Используй AI, сканируй мусор и получай{" "}
                  <span className="text-white">+25 XP и 5 O3</span> за каждый
                  скан.
                </p>
              </div>
            </Link>
            ...
            <div className="bg-emerald-500 p-8 rounded-[2.5rem] text-white shadow-xl shadow-emerald-100 relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-1 relative z-10 italic">
                Лига Мастеров
              </h3>
              <p className="text-emerald-100 text-[10px] font-black uppercase mb-6 relative z-10 tracking-widest">
                Топ игроков недели
              </p>
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-black">{userData.ozone} O3</p>
                  </div>
                </div>
                <h3 className="text-xl font-bold mb-1 italic">Маркетплейс</h3>
                <p className="text-orange-100 text-[10px] font-black uppercase tracking-widest">
      ...
      {selectedAch && (
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[70] flex items-center justify-center p-4">
          <div className="bg-white rounded-[2.5rem] p-10 max-w-sm w-full shadow-2xl text-center relative animate-in zoom-in duration-300">
            ...
            <div className="text-7xl mb-6 scale-110 drop-shadow-md">
              {selectedAch.icon}
            </div>
            ...
            <button
              onClick={() => setSelectedAch(null)}
              className="w-full bg-emerald-500 text-white py-4 rounded-2xl font-bold text-sm shadow-xl shadow-emerald-200 transition-all active:scale-95"
            >
              Закрыть
            </button>
          </div>
          ...
          <div className="bg-white rounded-[2.5rem] p-10 max-w-lg w-full shadow-2xl relative max-h-[90vh] overflow-y-auto custom-scrollbar border border-white/20">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100 text-center">
                <div
                  className={`w-24 h-24 rounded-3xl mx-auto mb-4 bg-gradient-to-tr ${editFields.photoGradient} relative overflow-hidden flex items-center justify-center text-white text-3xl font-black shadow-lg`}
                >
                  {userData.photoURL ? (
                    <img
                      alt="Avatar"
                ...
                <div className="flex justify-center gap-2">
                  {avatarGradients.map((g) => (
                    <button
                      ...
                      className={`w-7 h-7 rounded-full bg-gradient-to-tr ${g} ${editFields.photoGradient === g ? "ring-2 ring-emerald-500 ring-offset-2 scale-110" : "opacity-60"} transition-all`}
                    />
                  ))}
                </div>
              </div>
              ...
              <div>
                <label className="block text-[10px] font-black text-slate-400 uppercase mb-2 ml-2 tracking-widest flex items-center gap-1">
