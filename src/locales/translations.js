export const translations = {
  ru: {
    ...
    "sidebar.fightDesc": "Используй AI, сканируй мусор и получай",
  ...
  en: {
    ...
    "auth.subtitle": "Start scanning waste and save the planet",
    ...
    "profile.scanRewards": "Scan Rewards Table",
    "profile.nextLevel": "At level",
    "profile.allRewards": "You've unlocked all planned level rewards. Legend!",
    ...
    "sidebar.fightDesc": "Use AI, scan waste and get",
    "sidebar.nextLevel": "Next level",
    "sidebar.league": "Eco-Rating",
  ...
  de: {
    ...
    "auth.subtitle": "Beginne, Müll zu scannen und den Planeten zu retten",
    ...
    // Scanner
    "scanner.title": "Müll-Scanner",
    "scanner.takePhoto": "Foto aufnehmen",
    "scanner.scan": "Scannen",
    "scanner.points": "Du hast verdient",
    ...
    "sidebar.fightDesc": "Verwende KI, scanne Müll und verdiene",
    "sidebar.nextLevel": "Nächste Stufe",
    "sidebar.league": "Öko-Bewertung",
